  ...
  $.fn.mediumInsert.insert = {
    ...
    */
    getButtons: function (addon) {
      ...
      buttons = '<div class="mediumInsert-buttons">'+
            '<button class="mediumInsert-buttonsShow">+</button>'+
	 ...
	 /* buttons += '<div class="editor-comment"><span class="icon-uniE607"></span><div class="editor-comment-pop"></div></div>';*/
	  buttons += '<div class="editor-headings" ><span class="icon6-pilcrow editor-headings-icon"></span><div class="editor-headings-inner"><div class="editor-headings-normal"><span class="icon6-pilcrow"></span></div><div class="editor-headings-hs"><div class="editor-headings-h1">Hl</div><div class="editor-headings-h2">Hm</div><div class="editor-headings-h3">Hs</div></div></div></div></div>';
    ...
    */
    ...
    setEvents: function () {
      ...
      $el.on('click', '.mediumInsert-buttons button.mediumInsert-buttonsShow', function () {
      ...
      $el.on('mouseleave', '.mediumInsert', function () {
        $('button.mediumInsert-buttonsShow', this).removeClass('active');
  ...
  $.fn.mediumInsert.registerAddon('images', {
    ...
    */
    ...
    uploadCompleted: function (jqxhr, $placeholder) {
      ...
      if (jqxhr.responseText) {
        $progress.before('<figure class="mediumInsert-images"><img src="'+ jqxhr.responseText +'" draggable="true" alt=""><figcaption class="editor-image-caption"><span class="editor-image-caption-inner">type your image title</span></figcaption></figure>');
    ...
    */
    ...
    setImageEvents: function () {
	  ...
	  this.$el.on('click', '.editor-image-caption-inner', function () {
        var $placeholder = $(this).parent()
		$(this).text("")
		
           $formHtml = $('<div class="medium-editor-toolbar medium-editor-toolbar-active medium-editor-toolbar-form-anchor mediumInsert-imageLinkWire editor-image-caption-toolbar" style="display: block;"><input maxlength="50" type="text" value=""  class="editor-title-input-text"></div>');
      ...
      this.$el
		...
		this.$el
        .on('click', '.editor-title-input-text', function (e) {
		       $(this).focus();
		...
		this.$el
        .on('keyup', '.editor-title-input-text', function (e) {
		
        /*  var $placeholder = $(this).parent().siblings('.editor-image-caption-inner');
		  var $value = $( this ).val();
