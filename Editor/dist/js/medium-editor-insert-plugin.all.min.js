  ...
  $.fn.mediumInsert.insert = {
    ...
    */
    getButtons: function (addon) {
	  ...
	  buttons += '<div class="editor-comment"><span class="icon-uniE607"></span><div class="editor-comment-pop"></div></div></div>';
	  buttons += '<div class="editor-headings" ><span class="icon6-pilcrow editor-headings-icon"></span><div class="editor-headings-inner"><div class="editor-headings-normal"><span class="icon6-pilcrow"></span></div><div class="editor-headings-hs"><div class="editor-headings-h1">Hl</div><div class="editor-headings-h2">Hm</div><div class="editor-headings-h3">Hs</div></div></div></div>';
    ...
    setPlaceholders: function () {
      ...
      $el.keyup(function () {
        ...
        if ($lastChild.hasClass('mediumInsert') && $lastChild.find('.mediumInsert-placeholder').children().length > 0) {
          $el.append('<p><input class="editor-image-title" placeholder="add title to article"></input><br></p><p><br></p>');
        }
