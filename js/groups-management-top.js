	 ...
	 $(document).ready(function() {
			 ...
			 $(document).ready(function() {
				   ...
				   $(".application-recieved-btn").click(function(){
					...
					$("#close-group-btn").click(function(){
						
						$("#close-group-modal").modal('show');
					});
					
					$("#leave-group-btn").click(function(){
						
						$("#leave-group-modal").modal('show');
					});
					
					$("#open-session-popup").click(function(){
...
$("#add-interests-session-btn").click(function(e) {
		
		
    
           $(".session-keyword-list").append(" <div class='editor-all-tags'><span class='tag-text'>"+$("#session-keywords").val()+"</span><div class='tag-delete lnr lnr-cross'></div></div>");
	   $("#session-keywords").val('')
